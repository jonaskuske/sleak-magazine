...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"main.8bcc4678.js":[function(require,module,exports) {
var define;
...
parcelRequire = function (e, r, n, t) {
  ...
  "3Bcd": [function (require, module, exports) {
    ...
    Object.defineProperty(exports, "__esModule", {
      value: !0
    }), exports.startScrollObserver = v, exports.loadArticle = p, exports.default = void 0;
    ...
    var u = Promise.resolve(),
        c = (0, e.$)(".article").map(function (e, r) {
      return {
        element: e,
        index: r,
        name: e.id,
        path: "./articles/".concat(e.id, ".html"),
        inViewport: !1
      };
    }),
        s = function s(e) {
      return "number" == typeof e ? c[e] : c.find(function (r) {
        return r.name === e;
      });
    },
        l = function () {
        ...
        return regeneratorRuntime.wrap(function (t) {
          for (;;) {
            switch (t.prev = t.next) {
              case 0:
                return o = d.length > 1 && void 0 !== d[1] ? d[1] : {}, a = o.fromObserver, i = n.name, u = n.path, s = n.element, l = !!a && i !== c[0].name, t.next = 5, Promise.all([fetch(u).then(function (e) {
                  return e.text();
                }), l && (0, e.wait)(1200)]);

              case 5:
                if (f = t.sent, v = r(f, 1), p = v[0], "true" !== s.dataset.loaded) {
                  t.next = 10;
                  break;
                }
              ...
              case 10:
                return s.innerHTML = p, s.dataset.loaded = !0, t.abrupt("return");
      ...
      if (!("true" === e.element.dataset.loaded)) return r.fromObserver ? u = u.then(function () {
        e.inViewport && l(e, r);
      }) : l(e);
    };
    ...
    function v() {
      var e = new IntersectionObserver(function (e) {
        e.forEach(function (e) {
          var r = s(e.target.id);
          r.inViewport = e.isIntersecting, r.inViewport && f(r, {
            fromObserver: !0
          });
        });
      });
    ...
    function d() {
      return (d = i(regeneratorRuntime.mark(function r(t) {
        var n,
            o,
            a,
            i,
        ...
        return regeneratorRuntime.wrap(function (r) {
          for (;;) {
            switch (r.prev = r.next) {
              case 0:
                if (n = l.length > 1 && void 0 !== l[1] ? l[1] : {}, o = n.scroll, a = void 0 === o || o, i = s(t)) {
                  r.next = 4;
                  break;
                }

                return r.abrupt("return", console.warn("Artikel nicht gefunden: ".concat(t)));

              case 4:
                return u = c.filter(function (e, r) {
                  return r <= i.index;
                }).map(f), r.prev = 5, r.next = 8, Promise.all(u);
              ...
              case 10:
                return r.prev = 10, r.t0 = r.catch(5), r.abrupt("return", console.error("Fehler beim Laden des Artikels ".concat(i.name, ": ").concat(r.t0)));

              case 13:
                return r.next = 15, (0, e.wait)(1400);

              case 15:
                return a && i.element.scrollIntoView({
                  behavior: "smooth",
                  block: "start"
                }), r.abrupt("return", i);
  ...
  "9OMn": [function (require, module, exports) {
    "use strict";

    var e = require("."),
        t = n(require("./load-article"));
    ...
    var o = (0, e.$)(".article-selection")[0],
        a = o.querySelectorAll(".article-selection__button"),
        c = "article-selection__button--active",
        s = "article-selection__button--loading";
    ...
    function l() {
      return (l = i(regeneratorRuntime.mark(function e() {
        var n;
        return regeneratorRuntime.wrap(function (e) {
          for (;;) {
            switch (e.prev = e.next) {
              case 0:
                if (this.classList.add(s), n = parseInt(this.dataset.target, 10)) {
                  e.next = 4;
                  break;
                }
              ...
              case 4:
                return e.next = 6, (0, t.default)(n);

              case 6:
                this.classList.remove(s), f();
    ...
    function d() {
      document.body.classList.add("no-overflow"), o.classList.add("article-selection--open");
    }

    function f() {
      document.body.classList.remove("no-overflow"), o.classList.remove("article-selection--open");
    }

    a.forEach(function (e) {
      e.addEventListener("click", u);
    }), window.addEventListener("click", function (e) {
      e.target.matches(".article__number") && d();
    });

    var v = function v(e) {
      e.forEach(function (e) {
        var t = e.target;
        e.isIntersecting ? t.classList.add(c) : t.classList.remove(c);
      });
    },
        p = {
  ...
  "HJD/": [function (require, module, exports) {
    ...
    require("./utils/appshell"), require("./utils/article-selection");

    var e = require("./utils"),
        t = require("./utils/load-article"),
        o = function o() {
      var e = .01 * window.innerHeight;
      document.documentElement.style.setProperty("--vh", "".concat(e, "px"));
    };

    o(), window.addEventListener("resize", (0, e.debounce)(o, 500)), (0, t.loadArticle)(0, {
      scroll: !1
    }).then(function () {
      document.body.classList.remove("empty"), (0, t.startScrollObserver)();
    });
    var n = Boolean("ontouchstart" in window || window.navigator.maxTouchPoints > 0 || window.navigator.msMaxTouchPoints > 0 || window.DocumentTouch && document instanceof DocumentTouch);
    n && document.body.classList.add("supports-touch");
    var i = (0, e.$)(".js-splash")[0],
        r = (0, e.$)(".js-main")[0];
    ...
    s(), window.addEventListener("hashchange", s, !1);
  }, {
    "./utils/appshell": "WFx0",
    "./utils/article-selection": "9OMn",
    "./utils": "iWjG",
    "./utils/load-article": "3Bcd"
  }]
}, {}, ["HJD/"], null);
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","main.8bcc4678.js"], null)
//# sourceMappingURL=/main.8bcc4678.c25d7d61.map