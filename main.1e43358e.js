...
},{"./bundle-url":"node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"src/assets/styles/fonts.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./../fonts/BebasNeue.otf":[["BebasNeue.5fad5fb8.otf","src/assets/fonts/BebasNeue.otf"],"src/assets/fonts/BebasNeue.otf"],"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/normalize.css/normalize.css":[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/assets/styles/hamburgers.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/assets/styles/index.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/assets/styles/header.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/assets/styles/menu.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/assets/styles/article.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/assets/styles/utilities.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/assets/styles/subpages.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/assets/styles/index.js":[function(require,module,exports) {
"use strict";
...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"node_modules/intersection-observer/intersection-observer.js":[function(require,module,exports) {
/**
...
},{}],"src/utils/polyfills.js":[function(require,module,exports) {
"use strict";
...
_smoothscrollPolyfill.default.polyfill(); // IE workarounds
...
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","intersection-observer":"node_modules/intersection-observer/intersection-observer.js","whatwg-fetch":"node_modules/whatwg-fetch/fetch.js","smoothscroll-polyfill":"node_modules/smoothscroll-polyfill/dist/smoothscroll.js"}],"src/utils/index.js":[function(require,module,exports) {
"use strict";
...
},{"../assets/styles":"src/assets/styles/index.js","./polyfills":"src/utils/polyfills.js","./menu":"src/utils/menu.js","/Users/Rieke/Documents/CODE/sleak-magazine/serviceworker.js":[["serviceworker.js","serviceworker.js"],"serviceworker.map","serviceworker.js"]}],"src/utils/load-article.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            name = article.name, path = article.path, element = article.element; // Laden durch Observer: Verzögerung für alle Artikel außer dem ersten aktiv

            delay = fromObserver ? name !== articles[0].name : false; // Warten bis HTML des Artikels abgerufen und ggf. Wartezeit vorbei ist

            _context.next = 5;
            return Promise.all([fetch(path).then(function (response) {
              return response.text();
            }), delay && (0, _2.wait)(1200)]);
...
},{"./":"src/utils/index.js"}],"src/utils/article-selection.js":[function(require,module,exports) {
"use strict";

var _ = require(".");

var _loadArticle = _interopRequireDefault(require("./load-article"));
...
// HTML Elemente
var articleSelection = (0, _.$)('.article-selection')[0];
var articleSelectionButtons = articleSelection.querySelectorAll('.article-selection__button'); // CSS Klassen

var ACTIVE_CLASS = 'article-selection__button--active';
var LOADING_CLASS = 'article-selection__button--loading'; // Bei Klick auf Button Artikel laden/anzeigen
...
function _handleButtonClick() {
  _handleButtonClick = _asyncToGenerator(
  /*#__PURE__*/
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            _context.next = 6;
            return (0, _loadArticle.default)(target);
...
var ButtonObserver = new IntersectionObserver(handleIntersection, options);
var observeButton = ButtonObserver.observe.bind(ButtonObserver);
articleSelectionButtons.forEach(observeButton);
},{".":"src/utils/index.js","./load-article":"src/utils/load-article.js"}],"src/main.js":[function(require,module,exports) {
"use strict";

require("./utils/appshell");

require("./utils/article-selection");
